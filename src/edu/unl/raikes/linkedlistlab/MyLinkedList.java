...
public class MyLinkedList<E> implements List<E> {
    ...
    public void add(int index, E element) {
        ...
        if(head == null){
            ...
            for (int i = 0; i < size; i++) {
                if (i == index - 1) {
                    Node currentNode = new Node(element);
                    previousNode = getNode (i);
                    afterNode = getNode (i).next;
    ...
    public E remove(int objIndex) {
        ...
        if (this.head == null || objIndex == -1) {
            
            return null;
        } 
        
        if (objIndex == 0) {
            afterNode = getNode(0).next;
            E currentCargo = head.cargo;
            head = afterNode;
            size--;
            return currentCargo;
            ...
            E currentCargo = getNode(objIndex).cargo;
            beforeNode = getNode(objIndex - 1);
            afterNode = getNode(objIndex).next;
